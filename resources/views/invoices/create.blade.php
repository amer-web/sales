...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> > أضف فاتورة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('invoice.store')}}" method="POST" id="formData" style="font-weight: bold"
                          class="pb-5">
                        @csrf
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mg-b-0 text-md-nowrap ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" name="invoice[0][sale_price]"
        ...
        $(function () {
            ...
            $("#formData").on('click', '#addInvoice', function () {
                ...
                $("tbody.data").append('<tr>\n' +
                    ...
                    '    </select>\n' +
                    '    </td>\n' +
                    '    <td><input type="number" name="invoice[' + i + '][sale_price]" min="1" placeholder="سعر بيع الوحدة" class="sale_price" data-info="sale_price" style="height: 33px"></td>\n' +
                    '    <td><input type="number" name="invoice[' + i + '][amount]" min="1" placeholder="الكمية" class="amount" style="height: 33px"></td>\n' +
                    '    <td class="total">0.00\n' +
                    '\n' +
                    '    </td>\n <td>\n' +
