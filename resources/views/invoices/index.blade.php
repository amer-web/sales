...
@endsection
@section('title','إدارة فواتير المبيعات')
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">فواتير المبيعات</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ إدارة الفواتير </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('invoice.index')}}" data-parsley-validate="" method="get">
                        <div class="row mg-t-10 mg-b-10">
                            <div class="col-lg-4">
                                <label class="rdiobox"><input {{$requestRadio <= 1 ? 'checked' : '' }} name="rdio" type="radio" value="1"> <span>بحالة الفاتورة أو اسم العميل</span></label>
                            </div>
                        ...
                        <div class="row row-sm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="client_id" class="w-75 clients">
                                                ...
                                                @foreach($clients as $client)
                                                    <option value="{{$client->id}}" {{$requestClient == $client->id ? 'selected' : ''}}>{{$client->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 row justify-content-between">
                                ...
                                <a class="btn btn-outline-secondary pd-x-20 mg-t-10" href="{{route('invoice.index')}}"> الغاء الفلتر</a>
                            </div>
                        </div>
                    </form>
                </div>
