    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <a href="{{route('invoice.show', $invoice_refund->invoice->id)}}"><span
                        class="text-muted mt-1 tx-13 mr-2 mb-0"> > فاتورة رقم {{$invoice_refund->invoice->id}} للعميل {{$invoice_refund->invoice->client->name}} </span></a>
                <span
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('invoice-refund.update', $invoice_refund->id)}}" method="POST" id="formData"
                                ...
                                <div class="form-group mg-b-0">
                                    <label class="form-label">العميل: <span class="tx-danger">*</span></label>
                                        <select name="client_id" class="w-75 clients">
                                            <option value="{{$invoice_refund->invoice->client->id}}">{{$invoice_refund->invoice->client->name}}</option>
                                        </select>
                                </div>
                            </div>
                            <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table mg-b-0 text-md-nowrap ">
                                                ...
                                                @foreach($invoice_refund->salesRefund as $bellSale)
                                                    <tr>
                                                        <td class="w-25">
