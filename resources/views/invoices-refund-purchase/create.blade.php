...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('invoice-refund-purchase.store')}}" method="POST" id="formData"
                    ...
                    success: function (data, two) {
                        if (two === 'success') {
                            ...
                            if (data.purchase_price != null) {
                                let purchasePrice = data.purchase_price.purchase_price;
                                inputSalePrice.val(purchasePrice);
                                inputAmount.val(1);
